                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.horaInicioValueController ??=
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.horaCierreValueController ??=
                                              FormFieldController<String>(null),
                                      options: [
                                        '09:30',
                                        '11:30',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await DisponibilidadRecord.collection.doc().set({
                                ...
                                ...mapToFirestore(
                                  {
                                    'ListaHoras': functions.listaDeHoras(
                                        functions.stringADataTime(
                                            _model.horaInicioValue!),
                                        functions.stringADataTime(
                                            _model.horaCierreValue!)),
                                  },
                                ),
                              });
                              context.safePop();
