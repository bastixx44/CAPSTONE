  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<UsuarioRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRecord> perfilUsuarioUsuarioRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final perfilUsuarioUsuarioRecord =
            perfilUsuarioUsuarioRecordList.isNotEmpty
                ? perfilUsuarioUsuarioRecordList.first
                : null;
            ...
            body: SafeArea(
              ...
              child: StreamBuilder<List<UsuarioRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<UsuarioRecord> columnUsuarioRecordList = snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final columnUsuarioRecord = columnUsuarioRecordList.isNotEmpty
                      ? columnUsuarioRecordList.first
                      : null;
